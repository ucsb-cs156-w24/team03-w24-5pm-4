...
describe("ArticlesCreatePage tests", () => {
    ...
    test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
        ...
        fireEvent.change(urlField, { target: { value: 'https://fakeurl.com' } });
        fireEvent.change(explanationField, { target: { value: 'Article about places to eat' } });
        fireEvent.change(emailField, { target: { value: 'fakeemail@gmail.com' } });
        ...
        expect(mockToast).toBeCalledWith("New article Created - id: 12 title: Places to eat");
