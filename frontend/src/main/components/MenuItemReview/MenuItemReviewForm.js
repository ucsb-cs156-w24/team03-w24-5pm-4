                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {/* {errors.itemId?.type === 'pattern' && 'QuarterYYYYQ must be in the format YYYYQ, e.g. 20224 for Fall 2022'} */}
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control
                            ...
                            {...register("stars", { required: true, max: 5})}
                        />
                        <Form.Control.Feedback type="invalid">
                            {errors.stars && 'stars is required. '}
                            {errors.stars?.type === 'max' && '0 to 5 stars.'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
